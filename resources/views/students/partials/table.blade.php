...
<style>
    ...
    .stu-table tbody tr:hover td { background: #f8fcff; }
    ...
    .degree-badge.none { background: #f1f5f9; color: #94a3b8; }
    ...
    .action-btn.edit   { background: #eef6ff; color: #0ea5ff; }
...
@if ($message = Session::get('success'))
    <div style="background:#eff8ff;border:1px solid #93c5fd;color:#0369a1;border-radius:10px;padding:0.75rem 1rem;margin-bottom:1rem;display:flex;align-items:center;gap:0.5rem;font-size:0.85rem;font-weight:500;">
